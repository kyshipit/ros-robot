...
#include "eai_ros_bridge/msg/box.hpp"
#include "eai_ros_bridge/msg/detection_result.hpp"
#include "eai_ros_bridge/msg/point2_d.hpp"

namespace eai {
namespace ros_bridge {

inline eai_ros_bridge::msg::Box BuildBoxFromLine(const std::string& line) {
    eai_ros_bridge::msg::Box box;
...
inline eai_ros_bridge::msg::DetectionResult BuildDetectionResult(
    int frame_id,
    ...
    eai_ros_bridge::msg::DetectionResult msg;
